...
function Report() {
  ...
  const [modalContent, setModalContent] = useState({ title: '', description: '', pdfLink: '' });
  ...
  useEffect(() => {
    ...
    const goodKpisList = cosmosData.filter(item => item.$comparison === 'Good');
  ...
  const currentGuidelines = guidelines.slice(indexOfFirstGuideline, indexOfLastGuideline);
  ...
  const downloadReport = async () => {
    ...
    for (let page = 1; page <= Math.ceil(guidelines.length / guidelinesPerPage); page++) {
  ...
  return (
    <div className="bg-gradient-to-br mt-10 from-gray-900 via-gray-800 to-black min-h-screen p-8">
      <div className="max-w-5xl mx-auto bg-gray-800 rounded-lg shadow-lg overflow-hidden" id="report-content" ref={reportRef}>
        <div className="p-6">
          <motion.div
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <h2 className="text-lg font-semibold mb-2 text-white">KPIs with Poor Performance</h2>
            <div className="flex space-x-4">
              {badKpis.map((kpi, index) => (
                <div key={index} className="bg-gray-700 px-3 py-1 rounded-lg shadow-md">
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <h2 className="text-lg font-semibold mb-2 text-white">KPIs with Good Performance</h2>
            <div className="flex space-x-4">
          ...
          >
            <h2 className="text-lg font-semibold mb-2 text-white">Guidelines Related to Underperforming KPIs</h2>
            ...
            <div className="mt-4 flex justify-center">
              {Array.from({ length: Math.ceil(guidelines.length / guidelinesPerPage) }, (_, i) => (
                <button
                  key={i}
            ...
            >
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm text-left text-gray-300">
                  ...
                  <tbody>
                    {guidelines.slice(i * guidelinesPerPage, (i + 1) * guidelinesPerPage).map((guideline, index) => (
                      <motion.tr
                        key={index}
                        className="bg-gray-800 hover:bg-gray-700 transition-colors duration-300"
                        initial={{ opacity: 0, y: 10 }}
                      ...
                      >
                        ...
                        <td className="px-4 py-2">
                          <span className="text-blue-400">
                            <a href = {guideline.$pdf} download className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded"> 
                            Download Pdf
                            </a>
                          </span>
                        </td>
